    ...
    return (
        <div className="ed-root">
            <aside className="ed-sidebar">
                ...
                <div className="ed-logo-sub">Espace Stagiaire</div>
                {TABS.map(t => (
                    <button key={t.id}
                ...
                {tab === 'overview' && (
                    <>
                        ...
                        <div className="ed-card">
                            <div className="ed-card-title">🎯 Ma progression de stage</div>
                            <div className="ed-prog-row">
                                <div className="ed-prog-info"><span>Avancement</span><span>{done}/{tasks.length} — {pct}%</span></div>
                                <div className="ed-prog-track">
                                    <div className="ed-prog-fill" style={{
                                        width:`${pct}%`,
                                        background: pct > 70 ? 'linear-gradient(90deg,#059669,#34d399)' : pct > 40 ? 'linear-gradient(90deg,#d97706,#fbbf24)' : 'linear-gradient(90deg,#dc2626,#f87171)'
                                    }} />
                                </div>
                            </div>
                            <p style={{color:'#2d3055',fontSize:'.8rem',marginTop:'.5rem'}}>
                                {pct >= 80 ? '🌟 Stage excellent !' : pct >= 50 ? '💪 Bon avancement !' : '📌 Des tâches vous attendent.'}
                            </p>
                        </div>

                        <div className="ed-card">
                            <div className="ed-card-title">📋 Aperçu des tâches</div>
                            {tasks.length === 0
                                ? <div className="ed-empty">Aucune tâche assignée pour l'instant.</div>
